            ...
            <form method="POST" action="{{ route('empleado.create.post') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="salario" value="{{ old('salario') }}" class="form-control" id="exampleInputSalario1" required onkeypress="return filterFloat(event,this)">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="actividad" id="exampleInputHorario1">
                            ...
                            <option value="Vigilancia" {{ old('actividad') == 'Vigilancia' ? 'selected' : '' }} >Vigilancia</option>
                            <option value="Riego" {{ old('actividad') == 'Riego' ? 'selected' : '' }} >Riego</option>
                        </select>
                    </div>
                    {{--<div class="form-group">
